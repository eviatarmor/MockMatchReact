...
/**
 * Kibo UI tree — composable file/folder tree with expand/collapse.
 * Registry: npx shadcn add @kibo-ui/tree
 */
  ...
  const handleSelection = useCallback(
    (nodeId: string, ctrlKey = false) => {
      ...
      if (multiSelect && ctrlKey) {
        ...
        // Prefer sticky single-select for IDE file trees (always select, don't toggle off).
        newSelection = [nodeId]
      }
