...
export interface RoleDirectoryEntry {
  ...
  readonly resumeLayout:
    ...
    | "editorial"
    | "elegant"
  readonly letterLayout: "modern" | "classic" | "minimal" | "technical"
  readonly styleKey:
    | "tech"
    | "finance"
    | "consulting"
...
export const ROLE_DIRECTORY: readonly RoleDirectoryEntry[] = [
  ...
  { id: "amazon-sde", title: "Software Development Engineer", company: "Amazon", country: "US", category: "tech", avatarText: "A", description: "Leadership-principle bullets with hard metrics — Amazon SDE loop standard.", resumeLayout: "compact", letterLayout: "modern", styleKey: "tech", personKey: "usT", location: "Seattle, WA", headline: "SDE · Backend Services" },
  ...
  { id: "canva-frontend", title: "Frontend Engineer", company: "Canva", country: "AU", category: "tech", avatarText: "C", description: "Canvas perf, design systems, i18n — Canva creative-tool eng style.", resumeLayout: "banner", letterLayout: "modern", styleKey: "product", personKey: "auT", location: "Sydney, NSW", headline: "Frontend Engineer · Creative Tools" },
  { id: "deepmind-research-eng", title: "Research Engineer", company: "Google DeepMind", country: "UK", category: "tech", avatarText: "DM", description: "Research–engineering hybrid: evals + production ML — DeepMind UK bar.", resumeLayout: "elegant", letterLayout: "classic", styleKey: "tech", personKey: "ukT", location: "London, UK", headline: "Research Engineer · Machine Learning" },

  // Finance (10)
  { id: "goldman-ibd", title: "Investment Banking Analyst", company: "Goldman Sachs", country: "US", category: "finance", avatarText: "GS", description: "One-page deal-sheet density — classic bulge-bracket IBD format.", resumeLayout: "compact", letterLayout: "classic", styleKey: "finance", personKey: "usF", location: "New York, NY", headline: "Investment Banking Analyst · M&A" },
  { id: "jpm-markets", title: "Markets Analyst", company: "JPMorgan Chase", country: "US", category: "finance", avatarText: "JP", description: "Markets products + coverage metrics — JPM markets program style.", resumeLayout: "compact", letterLayout: "classic", styleKey: "finance", personKey: "usF", location: "New York, NY", headline: "Markets Analyst · Fixed Income" },
  ...
  { id: "blackrock-am", title: "Investment Analyst", company: "BlackRock", country: "US", category: "finance", avatarText: "BR", description: "Research process + portfolio risk language — asset manager format.", resumeLayout: "modern", letterLayout: "classic", styleKey: "finance", personKey: "usF", location: "New York, NY", headline: "Investment Analyst · Multi-Asset" },
  ...
  { id: "citi-risk", title: "Risk Analyst", company: "Citi", country: "US", category: "finance", avatarText: "CI", description: "VaR, limits, regulatory reporting — markets risk program style.", resumeLayout: "technical", letterLayout: "classic", styleKey: "finance", personKey: "usF", location: "New York, NY", headline: "Risk Analyst · Market Risk" },
  ...
  { id: "barclays-markets", title: "Markets Analyst", company: "Barclays", country: "UK", category: "finance", avatarText: "BX", description: "UK markets graduate format with MiFID/best-execution awareness.", resumeLayout: "compact", letterLayout: "classic", styleKey: "finance", personKey: "ukF", location: "London, UK", headline: "Markets Analyst · Equities" },
  { id: "macquarie-ib", title: "Investment Banking Analyst", company: "Macquarie", country: "AU", category: "finance", avatarText: "MQ", description: "AU infrastructure/project finance flavor — Macquarie-style deals.", resumeLayout: "executive", letterLayout: "classic", styleKey: "finance", personKey: "auF", location: "Sydney, NSW", headline: "Analyst · Infrastructure & Energy" },
  { id: "cba-risk", title: "Credit Risk Analyst", company: "Commonwealth Bank", country: "AU", category: "finance", avatarText: "CB", description: "Major AU bank risk: portfolio monitoring and policy exceptions.", resumeLayout: "modern", letterLayout: "classic", styleKey: "finance", personKey: "auF", location: "Sydney, NSW", headline: "Credit Risk Analyst · Retail" },
  ...
  { id: "bain-ac", title: "Associate Consultant", company: "Bain & Company", country: "US", category: "consulting", avatarText: "Bn", description: "PE diligence speed + results orientation — Bain AC style.", resumeLayout: "modern", letterLayout: "classic", styleKey: "consulting", personKey: "usC", location: "Chicago, IL", headline: "Associate Consultant · PE DD" },
  ...
  { id: "ey-parthenon", title: "Consultant", company: "EY-Parthenon", country: "UK", category: "consulting", avatarText: "EY", description: "Commercial diligence / transaction strategy — UK EY-P style.", resumeLayout: "executive", letterLayout: "classic", styleKey: "consulting", personKey: "ukC", location: "London, UK", headline: "Consultant · Transaction Strategy" },
  { id: "kpmg-advisory", title: "Advisor", company: "KPMG", country: "AU", category: "consulting", avatarText: "KP", description: "AU deal advisory: QoE, carve-outs, mid-market diligence.", resumeLayout: "modern", letterLayout: "classic", styleKey: "consulting", personKey: "auC", location: "Melbourne, VIC", headline: "Advisor · Deal Advisory" },

  // Healthcare (7)
  { id: "mayo-rn", title: "Registered Nurse", company: "Mayo Clinic", country: "US", category: "healthcare", avatarText: "MC", description: "Clinical CV: acuity, certifications, outcomes — top US hospital nursing format.", resumeLayout: "modern", letterLayout: "classic", styleKey: "healthcare", personKey: "usH", location: "Rochester, MN", headline: "Registered Nurse · Acute Care" },
  ...
  { id: "kaiser-pm", title: "Digital Health Product Manager", company: "Kaiser Permanente", country: "US", category: "healthcare", avatarText: "KP", description: "Member outcomes + compliance — integrated delivery digital PM style.", resumeLayout: "banner", letterLayout: "modern", styleKey: "product", personKey: "usH", location: "Oakland, CA", headline: "Product Manager · Digital Health" },
  { id: "pfizer-cra", title: "Clinical Research Associate", company: "Pfizer", country: "US", category: "healthcare", avatarText: "Pf", description: "Trial monitoring + GCP — large pharma research ops format.", resumeLayout: "compact", letterLayout: "classic", styleKey: "healthcare", personKey: "usH", location: "New York, NY", headline: "CRA · Oncology" },
  ...
  { id: "az-medical", title: "Medical Affairs Associate", company: "AstraZeneca", country: "UK", category: "healthcare", avatarText: "AZ", description: "UK medical affairs: scientific exchange + evidence generation.", resumeLayout: "elegant", letterLayout: "classic", styleKey: "healthcare", personKey: "ukH", location: "Cambridge, UK", headline: "Medical Affairs · Oncology" },
  { id: "nhs-cns", title: "Clinical Nurse Specialist", company: "NHS", country: "UK", category: "healthcare", avatarText: "NH", description: "NHS service improvement + MDT pathways — banded clinical leadership CV.", resumeLayout: "modern", letterLayout: "classic", styleKey: "healthcare", personKey: "ukH", location: "London, UK", headline: "CNS · Diabetes" },

  // Engineering (7)
  { id: "tesla-me", title: "Mechanical Engineer", company: "Tesla", country: "US", category: "engineering", avatarText: "T", description: "DFM, yield, cycle time — manufacturing hardware impact style.", resumeLayout: "compact", letterLayout: "modern", styleKey: "engineering", personKey: "usE", location: "Austin, TX", headline: "Mechanical Engineer · Manufacturing" },
  { id: "boeing-systems", title: "Systems Engineer", company: "Boeing", country: "US", category: "engineering", avatarText: "B", description: "Requirements, V&V, safety — aerospace systems rigor.", resumeLayout: "technical", letterLayout: "classic", styleKey: "engineering", personKey: "usE", location: "Seattle, WA", headline: "Systems Engineer · Avionics" },
  { id: "ge-electrical", title: "Electrical Engineer", company: "GE Vernova", country: "US", category: "engineering", avatarText: "GE", description: "Power systems, protection, standards — energy OEM style.", resumeLayout: "modern", letterLayout: "classic", styleKey: "engineering", personKey: "usE", location: "Schenectady, NY", headline: "Electrical Engineer · Power Systems" },
  { id: "lockheed-se", title: "Systems Engineer", company: "Lockheed Martin", country: "US", category: "engineering", avatarText: "LM", description: "Defense integration + test — mission systems format.", resumeLayout: "compact", letterLayout: "classic", styleKey: "engineering", personKey: "usE", location: "Bethesda, MD", headline: "Systems Engineer · Defense" },
  ...
  { id: "bhp-mining", title: "Mining Engineer", company: "BHP", country: "AU", category: "engineering", avatarText: "BH", description: "Safety + production + cost — major AU miner expectations.", resumeLayout: "technical", letterLayout: "classic", styleKey: "engineering", personKey: "auE", location: "Perth, WA", headline: "Mining Engineer · Open Pit" },
  { id: "riotinto-process", title: "Process Engineer", company: "Rio Tinto", country: "AU", category: "engineering", avatarText: "RT", description: "Recovery/throughput optimization — mineral processing ops tech.", resumeLayout: "modern", letterLayout: "classic", styleKey: "engineering", personKey: "auE", location: "Brisbane, QLD", headline: "Process Engineer · Mineral Processing" },
  ...
  { id: "cravath-lit", title: "Litigation Associate", company: "Cravath", country: "US", category: "legal", avatarText: "Cr", description: "Complex commercial litigation matters + motion practice.", resumeLayout: "editorial", letterLayout: "classic", styleKey: "legal", personKey: "usL", location: "New York, NY", headline: "Litigation Associate · Commercial" },
  ...
  { id: "ao-shearman", title: "Corporate Associate", company: "A&O Shearman", country: "UK", category: "legal", avatarText: "AO", description: "UK ECM: prospectuses, listings, market regulation awareness.", resumeLayout: "elegant", letterLayout: "classic", styleKey: "legal", personKey: "ukL", location: "London, UK", headline: "Corporate Associate · ECM" },
  { id: "kwm-au", title: "Corporate Associate", company: "King & Wood Mallesons", country: "AU", category: "legal", avatarText: "KW", description: "AU public M&A: schemes, takeovers, ASX process.", resumeLayout: "modern", letterLayout: "classic", styleKey: "legal", personKey: "auL", location: "Sydney, NSW", headline: "Corporate Associate · Public M&A" },
]
