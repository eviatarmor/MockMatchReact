...
import { ReadinessSessionHistory } from "./components/readiness-session-history"
import { OVERALL_SCORE, READINESS_AREAS, NEXT_UP_ITEMS, MOCK_SESSION_HISTORY } from "./constants"
        ...
        <DashboardPageHeader
          ...
          actions={
            <Button variant="outline" className="h-8 w-8 sm:w-auto px-0 sm:px-3 gap-1.5 cursor-pointer">
              ...
              <span className="hidden sm:inline">{t("readiness.exportReport")}</span>
            </Button>
          }
        />
