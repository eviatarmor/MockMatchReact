...
interface TrackedJobDetailsSheetProps {
  readonly job: TrackedJob | null
...
export function TrackedJobDetailsSheet({ job, open, onOpenChange }: TrackedJobDetailsSheetProps) {
  const { t } = useTranslation("common")
        ...
        {job && (
          <>
            ...
            <SheetFooter className="flex-row border-t">
              <SheetClose render={<Button variant="outline" className="flex-1 gap-1.5 cursor-pointer" />}>
