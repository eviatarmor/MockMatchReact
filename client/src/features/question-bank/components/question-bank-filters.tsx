...
interface QuestionBankFiltersProps {
  ...
  /** Optional facet counts from current list. */
  readonly domainCounts?: Partial<Record<QuestionDomain, number>>
  readonly difficultyCounts?: Partial<Record<QuestionDifficulty, number>>
  readonly statusCounts?: Partial<Record<QuestionStatus, number>>
}
